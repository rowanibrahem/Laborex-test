...
class CacheNetwork{
  ...
  static Future<bool> insertStringToCache({required String key , required String value})async{
  ...
  static Future<bool> insertIntToCache({required String key , required int value})async{
